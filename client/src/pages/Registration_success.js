...
import './Registration_success copy.css'
function RegSuc() {
    return (
      <>
    <div className="image">
    ...
    <div className="main">
        <div className="col1">
            <div className="pass">
                <p className="para1">Your Udgam Pass is Ready, You will recieve a mail confirming the payment and your
                    tickets will be attached along !</p>
                <div className="second"> <button className="fst">
                        Buy our cool Merch
                    </button>
                    <button className="scnd">
                        Didn't recive any mail?
                    </button>

                    <button className="thrd">
                        Face other issue
    ...
    <div className="col2">
        ...
        <div className="name">Divyesh Vankar</div>
        <div className="mailId">divyeshvankar.com</div>
        <img className="qr" src="../icons/dummyQR.png" alt=""/>
